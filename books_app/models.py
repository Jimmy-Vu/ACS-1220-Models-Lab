...
class Book(db.Model):
    ...
    favorited_by = db.relationship('User', secondary='favorite_book_table', back_populates='favorite_books')
...
class User(db.Model):
    ...
    favorite_books = db.relationship('Book', secondary='favorite_book_table', back_populates='favorited_by')
